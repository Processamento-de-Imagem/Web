    ...
    <div className="pdi-root">
      <div className="pdi-main">
        ...
        <div className="pdi-panel">
          <div className="pdi-panel-header">
            ...
            {inputImage && <span className="pdi-tag pdi-tag-ready">Pronto</span>}
          </div>
          <div className="pdi-panel-body">
            {inputImage ? (
              ...
              <div
                ...
                onDrop={handleDrop}
              >
                <svg className="pdi-upload-icon" width="36" height="36" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
            ...
            {outputState === "done" && etapaAtual && (
              <div className="pdi-carousel">
                ...
                {etapaAtual.descricao && (
                  <p className="pdi-carousel-descricao">{etapaAtual.descricao}</p>
                )}
                <div className="pdi-carousel-controls">
                  ...
                  <button
                    className="pdi-carousel-btn"
                    onClick={() => setCarouselIdx(i => Math.min(outputImage.length - 1, i + 1))}
      ...
      <div className="pdi-footer">
        ...
        >
          {isProcessing ? (
            <>
              <div className="pdi-spinner" style={{ width: 14, height: 14, borderWidth: 2 }} />
              Processando...
            </>
          ) : (
            <>
